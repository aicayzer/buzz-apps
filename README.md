...
During release-candidate evaluation, use `buzz-apps@next` or install the `.tgz` from [Releases](https://github.com/aicayzer/buzz-apps/releases). Registry installation becomes available after the initial npm publication.
